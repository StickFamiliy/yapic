...
Link: https://yapic.herokuapp.com/
...
- **create post** - As an user, I want to create and share posts through pics in an easy way so that I have a personal collection and stay in touch with similar profiles
